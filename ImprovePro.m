...
%%%%%%%%%%%%%%%%%%%
%%%%%%%%Stest%%%%%%%%%
% x=[50,75.7600000000000,72.1300000000000,20.1100000000000,52.1900000000000,13.1600000000000,27.3800000000000,94.4900000000000,96.6300000000000,95.4700000000000,90.0400000000000,81.3600000000000,41.1800000000000,0.300000000000000,41.9100000000000,32.2800000000000,41.1200000000000,51.0400000000000,62.4300000000000,30.0600000000000,19.5100000000000,99.6800000000000,44.9000000000000,47.7400000000000,18.2400000000000,78.2300000000000,48.9800000000000,18.1200000000000,6.39000000000000,57.4900000000000,17.4000000000000];
% y=[50,25.8400000000000,54.9900000000000,54.7600000000000,83.8400000000000,97.8500000000000,86.4700000000000,50.9200000000000,56.6500000000000,6.91000000000000,62.1900000000000,8.74000000000000,61.0800000000000,57.2100000000000,87.8700000000000,32.9400000000000,26.8000000000000,86.3300000000000,25.9000000000000,95.6400000000000,95.8100000000000,93.2100000000000,50.4800000000000,44.3700000000000,38.1400000000000,70.9800000000000,4.76000000000000,38.1200000000000,78.5700000000000,75.6000000000000,64.4300000000000];
%%%%%%%%%%%%%%%%%%%
%%%%%%%S2%%%%%%%%%%%%%%%
...
% trash
% hold on
% plot(35,65,'yo','MarkerEdgeColor','k','MarkerFaceColor','y');
% hold on
% plot(75,55,'yo','MarkerEdgeColor','k','MarkerFaceColor','y');
% hold on
% plot(10,40,'yo','MarkerEdgeColor','k','MarkerFaceColor','y');
% hold on
% plot(95,29,'yo','MarkerEdgeColor','k','MarkerFaceColor','y');
% hold on
% plot(x(1),y(1),'ko','MarkerEdgeColor','k','MarkerFaceColor','k');
% hold on
% plot(x(2:7),y(2:7),'go','MarkerEdgeColor','k','MarkerFaceColor','g');
% hold on
% plot(x(8:9),y(8:9),'go','MarkerEdgeColor','k','MarkerFaceColor','g');
% hold on 
% plot(x(9:10),y(9:10),'go','MarkerEdgeColor','k','MarkerFaceColor','g');
% hold on
% plot(x(11),y(11),'go','MarkerEdgeColor','k','MarkerFaceColor','g');
% hold on
% plot(x(12:end),y(12:end),'ro','MarkerEdgeColor','k','MarkerFaceColor','r');
% hold on
% plot(x(best_partRoute{1,1}),y(best_partRoute{1,1}),'-','LineWidth',0.2);
% hold on
% plot(x(best_partRoute{1,2}),y(best_partRoute{1,2}),'-','LineWidth',0.2);
% hold on
% plot(x(best_partRoute{1,3}),y(best_partRoute{1,3}),'-','LineWidth',0.2);
% hold on
% plot(x(best_partRoute{1,4}),y(best_partRoute{1,4}),'-','LineWidth',0.2);
% hold on
% plot(x(best_partRoute{1,5}),y(best_partRoute{1,5}),'-','LineWidth',0.2);
% hold on
% plot(x(best_partRoute{1,6}),y(best_partRoute{1,6}),'-','LineWidth',0.2);
% hold on
% plot(x(best_partRoute{1,7}),y(best_partRoute{1,7}),'-','LineWidth',0.2);
% hold on
% plot(x(best_partRoute{1,8}),y(best_partRoute{1,8}),'-','LineWidth',0.2);
%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%S3%%%%%%%%%
...
%% Init Parameters
global NUM N NR Tch Cs Ce Norig
NUM=400;                        %种群大小
Norig=300;                      %原生种群数量
Nmut=100;                        %突变体数量
NR=8;                           %机器人数量
